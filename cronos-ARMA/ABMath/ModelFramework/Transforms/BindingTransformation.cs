...
namespace ABMath.ModelFramework.Transforms
{
    ...
    public class BindingTransformation : TimeSeriesTransformation
    {
        ...
        [CategoryAttribute("Parameter"), Description("Number of inputs to be bound into a multivariate series.")]
        public int NumberOfInputs
        { get; set; }
        [CategoryAttribute("Parameter"), Description("If true, will fill in missing values by sampling.")]
