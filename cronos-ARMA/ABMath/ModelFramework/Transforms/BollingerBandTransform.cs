...
namespace ABMath.ModelFramework.Transforms
{
    ...
    {
        [CategoryAttribute("Parameter"), Description("Number of periods to use for rolling mean/std.dev.")]
        public int NumPeriods { get; set; }
        [CategoryAttribute("Parameter"), Description("# of standard deviations from mean at which to put bands.")]
