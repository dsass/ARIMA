...
namespace ABMath.ModelFramework.Transforms
{
    ...
    {
        [CategoryAttribute("Parameter"), Description("Autoregressive Filter Coefficients")]
        public double[] arCoeffs { get; set; }
        [CategoryAttribute("Parameter"), Description("Moving Average Filter Coefficients")]
        public double[] maCoeffs { get; set; }
        [CategoryAttribute("Parameter"), Description("If non-zero, uses the specified time interval instead of just using successive data points")]
