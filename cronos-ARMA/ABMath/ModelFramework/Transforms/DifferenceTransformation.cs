...
namespace ABMath.ModelFramework.Transforms
{
    ...
    public class DifferenceTransformation : TimeSeriesTransformation
    {
        ...
        [CategoryAttribute("Parameter"), Description("Lag at which to difference")]
        public int Lag { get; set; }
        [CategoryAttribute("Parameter"), Description("Time stamp mode: if true, the time stamp is at the beginning of the interval, if false, it's at the end.")]
        public bool LeftTimeStamps { get; set; }
        [CategoryAttribute("Parameter"), Description("Padding: set to true to pad output with zeros")]
        public bool PadWithZeroes { get; set; }
        [CategoryAttribute("Parameter"), Description("Spacing at which to sample input")]
        public int Spacing { get; set; }
        [CategoryAttribute("Parameter"), Description("Offset used if spacing is greater than 1")]
