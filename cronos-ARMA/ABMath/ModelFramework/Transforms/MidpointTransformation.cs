...
namespace ABMath.ModelFramework.Transforms
{
    ...
    public class MidpointTransformation : TimeSeriesTransformation
    {
        ...
        [CategoryAttribute("Parameter"), Description("Limit: when bid-ask spread is greater than this, no midpoint is recorded.")]
        public double SpreadLimit
        { get; set; }
        [CategoryAttribute("Parameter"), Description("Name to Assign to Result")]
