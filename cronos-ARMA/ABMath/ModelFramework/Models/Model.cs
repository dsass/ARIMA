...
namespace ABMath.ModelFramework.Models
{
    ...
    public abstract class Model : IConnectable
    {
        ...
        /// </summary>
        /// <param name="inputs">these may have different interpretations, but
        /// for time series, is typically an IList of DateTime objects</param>
        ...
        /// <param name="inputs">may have different interpretations, for
        /// time series, it is typically an IList of DateTime objects</param>
